...
secureServer = createServer({
  ...
  debug: debug: (config.AUTO_SNI_DEBUG ===true), // Add console messages and uses staging LetsEncrypt server. (Disable in production)
  ...
  ports: {
    ...
    https: https: parseInt(config.PORT_HTTPS) // Optionally override the default https port.
  }
}, app);
